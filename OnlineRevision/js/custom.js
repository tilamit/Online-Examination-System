$(document).ready(function () {
    ...
    $(function () {
        $(".primary-btn").click(function () {
            ...
            if(session == "" || session == null) {
               //alert("Please login or register first for payment!");
    ...
    $("body").on("click", "#btnCard", function (e) {
        ...
        {
            Stripe.setPublishableKey("pk_test_51HSmHXJXqX9mCgd9JaMxI3TwaBqJzNJs1pbk6gjQYsuLPYFd7CdcN8nxYTSDnZ71S1drIwSarxCVJ9tHhLdVUzPu009koz6atM");
            e.preventDefault();
            e.stopPropagation();
